          ...
          <nav class="navbar navbar-inverse">
              <div class="container-fluid">
                  ...
                  <div class="navbar-header">
                      ...
                      <li class="active"><a class="navbar-brand" href="javascript:void(0);" id="home_page">首页</a></li>
                  </div>

                  <!-- Collect the nav links, forms, and other content for toggling -->
                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav">
                          <li><a href="javascript:void(0);" id="task_center">创意方案交易中心<span class="sr-only">(current)</span></a></li>
                          <li><a href="javascript:void(0);" id="list">创意方案交易热门案例</a></li>
                          <li class="dropdown">
                      ...
                      <ul class="nav navbar-nav navbar-right">
                          <li class="dropdown">
                              <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="${path}/static/images/user/user.jpg" alt="头像" width="20px" height="20px"><span class="caret"></span></a>
                              <ul class="dropdown-menu">
