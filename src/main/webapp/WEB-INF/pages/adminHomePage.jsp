...
<%--    <link rel="stylesheet" href="${path}/static/css/bootstrap.min.new.css"/>--%>
    ...
    <script type="application/javascript" src="${path}/static/js/adminHomePage_actions.js?ver=1"></script>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="javascript:void(0)"><span class="glyphicon glyphicon-home"></span>&nbsp;&nbsp;后台首页</a></li>
                ...
                <li><a href="/jump/adminMessage"><span class="glyphicon glyphicon-envelope"></span>&nbsp;&nbsp;查看留言</a></li>
            </ul>
