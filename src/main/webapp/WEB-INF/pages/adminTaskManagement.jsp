...
<%--    <link rel="stylesheet" href="${path}/static/css/bootstrap.min.new.css"/>--%>
    ...
    <script type="application/javascript" src="${path}/static/js/adminTaskManagement_actions.js?ver=1"></script>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="javascript:void(0)"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;交易管理</a></li>
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                <a href="javascript:void(0)" class="list-group-item active" id="task-management">任务审核</a>
                <a href="javascript:void(0)" class="list-group-item" id="deal-record">用户交易记录</a>
            </div>
        </div>
        <div class="col-md-10">
