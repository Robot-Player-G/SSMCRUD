...
<%--    <link rel="stylesheet" href="${path}/static/css/bootstrap.min.new.css"/>--%>
    ...
    <script src="${path}/static/js/jquery.min.js"></script>
    <script type="application/javascript" src="${path}/static/js/adminUserManagement_actions.js?ver=1"></script>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li name="top"><a href="/jump/adminHomePage"><span class="glyphicon glyphicon-home"></span>&nbsp;&nbsp;后台首页</a></li>
                <li class="active" name="top"><a href="javascript:void(0)"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;用户管理</a></li>
                <li name="top"><a href="/jump/adminTaskManagement"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;交易管理</a></li>
                <li name="top"><a href="/jump/adminMessage"><span class="glyphicon glyphicon-envelope"></span>&nbsp;&nbsp;查看留言</a></li>
            </ul>
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                <a href="javascript:void(0)" class="list-group-item active" id="user-management" name="left">用户管理</a>
                <a href="javascript:void(0)" class="list-group-item" id="recharge-record" name="left">用户充值记录</a>
            </div>
        </div>
        <div class="col-md-10">
